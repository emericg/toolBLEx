...
Item {
    ...
    Row { // wifi // 802.11b
        ...
        anchors.leftMargin: ((overlayFrequencyBands.width / 100) * 1)
        anchors.bottom: parent.bottom
        spacing: -((overlayFrequencyBands.width / 100) * 17)
        ...
        Repeater {
            ...
            Rectangle {
                ...
                anchors.topMargin: ((overlayFrequencyBands.width / 100) * 11)

                width: ((overlayFrequencyBands.width / 100) * 22)
                height: ((overlayFrequencyBands.width / 100) * 22)
                radius: width
    ...
    Row { // wifi // 802.11g/n
        ...
        height: 400
        spacing: -((overlayFrequencyBands.width / 100) * 15)
        ...
        Repeater {
            ...
            Item {
                ...
                width: (overlayFrequencyBands.width / 100) * 20
                height: 48
    ...
    Row { // bluetooth // low energy
        anchors.left: parent.left
        anchors.leftMargin: ((overlayFrequencyBands.width / 100) * 1.5)
        anchors.bottom: parent.bottom

        visible: (actionBar.bluetooth && actionBar.bluetooth_lowenergy)
        spacing: (overlayFrequencyBands.width / 100)

        Repeater {
            model: 40
            Item {
                width: (overlayFrequencyBands.width / 100)
                height: 256
    ...
    Row { // zigbee // 802.15.4
        ...
        spacing: ((overlayFrequencyBands.width / 100) * 3)

        Repeater {
            model: 16

            Item {
                width: ((overlayFrequencyBands.width / 100) * 2)
                height: 256
